...
import {Platform, View, TextInput, StyleSheet, Text, ScrollView,StatusBar,Image} from 'react-native';
...
class Dietplan extends Component{
    ...
    render(){
        return(
            ...
            <Image source={require('../img/food.jpg')} style={{flexDirection: 'row', flexWrap: 'wrap'}}/>
            </View>
